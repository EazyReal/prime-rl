...
from prime_rl.transport.types import MicroBatch, RoutedExperts, TrainingAdvantage, TrainingSample
...
def prepare_sample(training_example: TrainingSample, seq_len: int) -> MicroBatch:
    ...
    if len(input_ids) > seq_len:
        ...
        advantages = [_slice_advantage(channel, seq_len) for channel in advantages]
